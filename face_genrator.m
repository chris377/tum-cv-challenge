function [x_max,z_max,y_max,imBottomBlend,imUpBlend,imMiddleBlend,imLeftBlend,imRightBlend,z_fore,max_depth,imForegroundBlend] = face_genrator(I,vp_x,vp_y,irx,iry,foreground,foreground_image,cpOutx,cpOuty,cpx,cpy)
